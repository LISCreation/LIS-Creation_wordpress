        ...
        <nav class="mono">
            <ul class="mono-menu">
                <li class="mono-menu_item">
                    <a class="anchor" href="#"><div class="tab">Начало экрана</div></a>
                </li>
                <li class="mono-menu_item">
                    <a class="anchor" href="#"><div class="tab">Начало экрана 2</div></a>
                </li>
                <li class="mono-menu_item">
                    <a class="anchor" href="#"><div class="tab">Начало экрана Начало экрана</div></a>
                </li>
                <li class="mono-menu_item">
                    <a class="anchor" href="#"><div class="tab">Начало экрана Начало экранаНачало экрана</div></a>
                </li>
                <li class="mono-menu_item">
                    <a class="anchor" href="#"><div class="tab">Начало экрана Начало экрана</div></a>
                </li>
                <li class="mono-menu_item">
                    <a class="anchor" href="#"><div class="tab">Начало экрана 32</div></a>
                </li>
            </ul>
        </nav>
    </div>
...
<div class="global-wrapper serv">
    ...
    <section class="process">
        <div class="container">
            <div class="section-info">
                <h2 class="section-header">создание landing page</h2>
                <p class="section-description">Когда требуется обратить внимание клиента на ваш определенный товар
                    или услугу, то значит, вам необходим Landing - продающая страница!
                    Наша команда профессионалов предлагает интересные решения
                    для эффективной продажи и продвижения
                    вашего товара или услуги. </p>
            </div>
            <div class="process-info">
                ...
                <div class="process-numbers">
                    <p class="process-price">Срок разработки проекта - <span>14-21 дней</span></p>
                    <p class="process-duration">Стоимость проекта - <span>от 21 990 руб.</span></p>
                </div>
    ...
    <section class="listing offer" id="offer">
        <div class="container">
            <div class="section-info">
                ...
                <p class="section-description">Для Вашего удобства мы разработали систему «под ключ» - от вашей
